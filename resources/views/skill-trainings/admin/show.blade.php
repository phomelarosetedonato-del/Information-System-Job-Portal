...
@section('title', $skillTraining->title . ' - Admin')
            ...
            <div class="card">
                ...
                <div class="card-footer">
                    <div class="d-flex justify-content-between">
                        ...
                        <div>
                            <a href="{{ route('admin.skill-trainings.edit', $skillTraining) }}" class="btn btn-warning">
                                <i class="fas fa-edit"></i> Edit
                            </a>
                            <form action="{{ route('admin.skill-trainings.destroy', $skillTraining) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <a href="{{ route('admin.skill-trainings.enrollments', $skillTraining) }}"
                        ...
                        <form action="{{ route('admin.skill-trainings.toggle-status', $skillTraining) }}" method="POST" class="d-inline">
                            @csrf
                            <button type="submit" class="btn btn-outline-warning w-100 text-start">
                                <i class="fas {{ $skillTraining->is_active ? 'fa-pause' : 'fa-play' }}"></i>
                                {{ $skillTraining->is_active ? 'Deactivate' : 'Activate' }} Training
                            </button>
                        </form>
                    </div>
                </div>

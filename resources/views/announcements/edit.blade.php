                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.announcements.update', $announcement->id) }}">
                        ...
                        <div class="alert alert-info">
                            ...
                            <strong>Announcement Metadata:</strong>
                            <ul class="mb-0 mt-2">
                                <li><strong>Created:</strong> {{ $announcement->created_at->format('F d, Y \a\t h:i A') }}</li>
                                <li><strong>Last Updated:</strong> {{ $announcement->updated_at->format('F d, Y \a\t h:i A') }}</li>
                                @if($announcement->creator)
                                    <li><strong>Created By:</strong> {{ $announcement->creator->name }}</li>
                                @endif
                            </ul>
                        </div>

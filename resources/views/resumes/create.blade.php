...
@section('title', 'Create Professional Resume')
    ...
    <div class="container-fluid">
        ...
        <div class="resume-paper">
            ...
            <div class="resume-header">
                <h2 class="mb-1"><i class="fas fa-file-alt me-2"></i>Create Your Professional Resume</h2>
                <p class="mb-0 small">Fill in your information to create a professional resume</p>
            </div>
            ...
            <form action="{{ route('resumes.store') }}" method="POST" enctype="multipart/form-data" id="resumeForm">
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" name="surname" class="form-control" value="{{ old('surname', $defaultData['surname'] ?? '') }}" required>
                        @error('surname')
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" name="first_name" class="form-control" value="{{ old('first_name', $defaultData['first_name'] ?? '') }}" required>
                        @error('first_name')
                            <div class="text-danger small mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" name="middle_name" class="form-control" value="{{ old('middle_name', $defaultData['middle_name'] ?? '') }}">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="date" name="date_of_birth" class="form-control" value="{{ old('date_of_birth', $defaultData['date_of_birth'] ?? '') }}" required>
                        @error('date_of_birth')
                            <div class="text-danger small mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="sex" class="form-select" required>
                            ...
                            <option value="male" {{ old('sex', $defaultData['sex'] ?? '') == 'male' ? 'selected' : '' }}>Male</option>
                            <option value="female" {{ old('sex', $defaultData['sex'] ?? '') == 'female' ? 'selected' : '' }}>Female</option>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="tel" name="mobile_number" class="form-control" value="{{ old('mobile_number', $defaultData['mobile_number'] ?? '') }}" placeholder="+639123456789" required>
                        @error('mobile_number')
                            <div class="text-danger small mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="email" name="email_address" class="form-control" value="{{ old('email_address', $defaultData['email_address'] ?? '') }}" required>
                        @error('email_address')
                            <div class="text-danger small mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="province" class="form-control" value="{{ old('province', $defaultData['province'] ?? 'Pangasinan') }}" required>
                        @error('province')
                            <div class="text-danger small mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="complete_address" class="form-control" rows="2">{{ old('complete_address', $defaultData['complete_address'] ?? '') }}</textarea>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="professional_summary" class="form-control" rows="4" placeholder="Brief overview of your professional background and expertise...">{{ old('professional_summary') }}</textarea>
                    <small class="text-muted">2-3 sentences highlighting your key strengths</small>
                </div>

                <div class="mb-3">
                    <label class="form-label">Career Objective</label>
                    <textarea name="career_objective" class="form-control" rows="3" placeholder="Your career goals and aspirations...">{{ old('career_objective') }}</textarea>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="course" class="form-control" value="{{ old('course') }}" placeholder="e.g., BS Computer Science">
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" name="year_graduated" class="form-control" value="{{ old('year_graduated') }}" min="1950" max="{{ date('Y') + 10 }}">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="visibility" class="form-select">
                            ...
                            <option value="employers_only" selected>Employers Only</option>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="form-check form-switch mt-2">
                            <input class="form-check-input" type="checkbox" name="is_searchable" id="isSearchable" value="1">
